...
//   useEffect(() => {
//     console.log(purchaseOrder, "this is the po order data");
//   }, [purchaseOrder]);
...
//           <tbody>
//             {rows.map((r, i) => {
//               let base = (r.qty || 0) * (r.rate || 0);
//               let perUnitDisc = ((r.rate || 0) * (r.d1_percent || 0)) / 100;
//               let totalDisc = (r.qty || 0) * perUnitDisc;
...
//                 base = (r.qty || 0) * (r.rate || 0) * 1000;
//                 perUnitDisc =
//                   (((r.rate || 0) * (r.d1_percent || 0)) / 100) * 1000;
//                 totalDisc = (r.qty || 0) * perUnitDisc;
