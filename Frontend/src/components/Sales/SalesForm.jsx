      ...
      try {
        ...
        if (isEditMode && sale) {
          ...
          try {
            ...
            //   customer_id: so?.party_id || "",
            //   address: selectedCustomer?.address || so.address || "",
            //   mobile_no: selectedCustomer?.phone || so.mobile_no || "",
            //   gst_no:
            ...
            //   cash_received: 0,
            //   buyer_type: "Retailer",
            //   party_balance: Number(selectedCustomer?.balance ?? 0),
            //   party_min_balance: Number(selectedCustomer?.min_balance ?? 0),
            //   other_amount: so?.other_amount || 0,
