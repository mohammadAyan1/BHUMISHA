...
const PurchaseBillsTable = () => {
  ...
  const totalAmount = useMemo(() => {
    return filteredBills.reduce((s, b) => s + Number(b.total_amount || 0), 0);
  }, [filteredBills]);
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <input
                type="text"
                placeholder="Search by product, vendor, farmer, bill no, HSN, category..."
                value={search}
                ...
                <tbody className="divide-y divide-gray-200">
                  {filteredBills.length === 0 ? (
                    ...
                    displayedBills.map((bill, index) => {
                      ...
                      const firstProduct = bill.items?.[0];
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-gray-700">
                            {bill.vendor_name || bill.farmer_name || "-"}
                          </td>
                          <td className="px-4 py-3 text-gray-700">
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-lg border border-gray-200">
                    ...
                    <div className="sm:col-span-2 md:col-span-3">
                      ...
                      <p className="text-lg font-semibold text-gray-800 mt-1">
                        {modalData.vendor_name || modalData.farmer_name || "-"}
                      </p>
                    </div>
                  </div>
                        ...
                        {modalData.items?.map((item, idx) => (
                          <tr key={idx} className="hover:bg-blue-50 transition">
                            ...
                            <td className="px-4 py-3 text-right font-semibold text-blue-600">
                              {Number(item?.total ?? item?.amount ?? 0).toFixed(
                                2
                              )}
                            </td>
                          </tr>
