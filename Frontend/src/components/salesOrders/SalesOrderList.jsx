              ...
              return (
                ...
                >
                  ...
                  <td className="border p-2 text-right font-semibold">
                    {fx((r?.summary?.grand_total ?? r.final_amount ?? 0) + Number(r?.other_amount || 0))}
                  </td>
            ...
            <div className="px-5 pb-5">
              ...
              <div className="mt-4 flex justify-end text-sm">
                <div>
                  ...
                  <div>
                    Remark: {selected?.other_note || "—"}
                  </div>
                  <div className="font-semibold text-base">
                    Grand Total:{" "}
                    {fx(
                      (selected?.summary?.grand_total ?? selected?.final_amount ?? 0) +
                        Number(selected?.other_amount || 0),
                      2
                    )}
                  </div>
                </div>
