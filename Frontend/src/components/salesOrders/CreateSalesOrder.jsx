...
// const calcLine = (r) => {
//   // r.qty is in the selected unit, r.rate is per selected unit
//   const qty = Number(r.qty || 0);
//   const rate = Number(r.rate || 0); // rate per selected unit
//   const d1 = Number(r.d1_percent) || 0;
//   const gst = Number(r.gst_percent) || 0;
//   const unit = r.unit || "kg";

//   // Calculate amount: qty * rate per selected unit
//   const amount = qty * rate;

//   // Discount is percentage of rate
//   const discPerUnit = (rate * d1) / 100;
