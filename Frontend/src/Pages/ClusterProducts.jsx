...
const ClusterProducts = () => {
  ...
  useEffect(() => {
    dispatch(fetchGivenClusterProducts())
      .then((res) => {
        console.log("Fetched given cluster products:", res);
  ...
  const handleSubmit = useCallback(
    (e) => {
      ...
      console.log("Submitting cluster products payload:", payload);
      dispatch(addClusterProduct(payload)).then((res) => {
        console.log("Add cluster products response:", res);
  ...
  console.log("Cluster Products:", clustorProducts);
