...
async function generateSalaryByMe(req, res) {
  try {
    ...
    if (sendingDay > salaryDay) {
      ...
      console.log(myCurrectCondition, "myCurrectCondition");
      ...
      console.log(finalDate, "this is the final date");
      console.log(toDate);
      ...
      console.log(totalDaysFromGivenDate, "total days");
    ...
    const holidayDates = holidayRows.map((h) => h.holiday_date);
